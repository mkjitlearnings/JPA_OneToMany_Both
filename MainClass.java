...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		Account a = new Account();
		  ...
		  com.capg.jpa.p1.Transaction t1 = new com.capg.jpa.p1.Transaction(LocalDateTime.now(), 5000,"Deposite");
		  com.capg.jpa.p1.Transaction t2 = new com.capg.jpa.p1.Transaction(LocalDateTime.now(), 4000,"Withdrawal");
		  
		  List<com.capg.jpa.p1.Transaction> transactionsList = Arrays.asList(t1,t2);
		  
		  a.setTransactions(transactionsList);
		  ...
		  System.out.println("\n Transaction Details "+account.getTransactions());
